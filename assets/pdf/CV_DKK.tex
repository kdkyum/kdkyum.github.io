...
\noindent My research combines AI, physics, and neuroscience to uncover the mechanisms of learning and memory in large language models. Using representation geometry and causal interventions across mechanistic interpretability, model editing, and machine unlearning, I study how models store, retrieve, revise, and forget knowledge, as well as why attempts to alter it fail. My training in physics guides me toward simple principles behind complex behavior, while neuroscience provides testable hypotheses about memory formation and consolidation. Building on this foundation, I aim to determine how reinforcement learning preserves existing capabilities and selectively consolidates reward-relevant experience, and to translate these mechanisms into safer, more reliable, and more efficient continual learning methods.
...
\section{\texorpdfstring{Selected Publications \hfill {\normalfont\small $^\dagger$ denotes equal contribution.}}{Selected Publications}}

\begin{enumerate}[label={[S\arabic*]}, leftmargin=24pt, itemsep=3pt]

    \item Jea Kwon$^\dagger$, \textbf{Dong-Kyum Kim}$^\dagger$, Jiwon Kim$^\dagger$, Yonghyun Kim, Woong Kook, and Meeyoung Cha.
...
\cvdatedentry{KIAS AI and Natural Sciences Seminar (Seoul, Korea)}
    {\textit{``Nonequilibrium Statistical Physics Study Using Deep Learning''}}
    {Apr. 27, 2022}
...
% === FULL PUBLICATIONS ===
\section{\texorpdfstring{Publications \hfill {\normalfont\small $^\dagger$ denotes equal contribution.}}{Publications}}
...
\noindent\textbf{Program Committee}: AAAI 2027, CIKM 2026.
\par\noindent\textbf{Reviewer}: TMLR, NeurIPS 2026, ICML 2026 Workshop on Mechanistic Interpretability,
