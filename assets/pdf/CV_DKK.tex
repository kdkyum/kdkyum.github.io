...
\begin{itemize}
    \item \textbf{Interdisciplinary physicist} bridging AI, statistical physics, and neuroscience.
    \item \textbf{How AI stores knowledge}: interpretability, model editing, and machine unlearning in large language models.
    \item \textbf{Physics \& brains for AI}: deep learning for nonequilibrium statistical physics, and brain-inspired models of memory.
\end{itemize}
...
\begin{itemize}
    \item Improved anomaly image classification via distributed multi-GPU training (Keras \& Spark), with \href{https://www.linkedin.com/in/danielyounghokim/}{Daniel Kim} (Senior Data Scientist)
    \item Built a distributed image search framework using Elasticsearch
\end{itemize}
