...
\fancyfoot[C]{\footnotesize Last updated: June 2026}
...
\begin{center}
    ...
    \href{mailto:kdkyum531@gmail.com}{\faEnvelope\,\, kdkyum531@gmail.com} $\cdot$
    ...
    \href{https://www.linkedin.com/in/kdkyum}{\faLinkedin\,\, LinkedIn}
\end{center}

% === SUMMARY ===
\section{Summary}
I am studying how AI systems store, retrieve, and update their knowledge. My research looks inside large language models
to understand how they represent information and what can go wrong when we try to edit or remove knowledge from them. My
background is in statistical physics and neuroscience, and I use ideas from learning and memory research in the brain to
study how these systems work internally. I believe that understanding internal information processing in AI systems is
essential for making them safer and more controllable.

% === EDUCATION ===
\section{Education}
\textbf{Korea Advanced Institute of Science and Technology (KAIST)} \hfill 2016--2022 \\
Ph.D. in Physics \hfill Advisor: Prof.\ \href{https://www.linkedin.com/in/hawoong-jeong-b195b6a/}{Hawoong Jeong} \\
{\small Dissertation: \textit{Nonequilibrium Statistical Physics Study using Deep Learning}}

\vspace{4pt}
\textbf{Seoul National University (SNU)} \hfill 2011--2015 \\
...
2024--Present
\begin{itemize}
    \item Hosted by Prof.\ \href{https://www.linkedin.com/in/miacha/}{Meeyoung Cha} (Director)
...
\begin{itemize}
    \item Collaborated with \href{https://www.linkedin.com/in/danielyounghokim/}{Daniel Kim} (Senior Data Scientist)
    \item Improved anomaly image classification via distributed multi-GPU training (Keras \& Spark)
    \item Implemented a distributed image searching framework via Elasticsearch
\end{itemize}
...
primary research workflow.
    ...
    \item \textbf{Infrastructure}: Distributed training training \& inference (Slurm system with hundreds of H100s),
large-scale data pipelines
\end{itemize}

% === REVIEWING ===
\section{Academic Service}
\textbf{Reviewer}: ICML 2026 Workshop Mechanistic Interpretability, ICML 2026 (Received Gold Reviewer Award), ICLR 2026,
NeurIPS 2025, ICML 2025 Workshop World Models, ICLR 2025 Workshop Re-Align, NeurIPS 2024 Workshop Behavioral ML, ICML
2024 Workshop LLMs and Cognition.
...
\begin{description}[leftmargin=0pt,topsep=0pt]
    ...
    \faEnvelope \space mia.cha@mpi-sp.org \\

    \item[\href{https://yongjoobaek.wordpress.com}{Yongjoo Baek}] \hfill \\
    Professor \\
    Department of Physics \& Astronomy, SNU \\
    \faEnvelope \space y.baek@snu.ac.kr
\end{description}
\columnbreak
\begin{description}[leftmargin=0pt,topsep=0pt]
    \item[\href{http://stat.kaist.ac.kr/~hjeong/}{Hawoong Jeong}] \hfill \\
    Professor \\
    Department of Physics, KAIST \\
    \faEnvelope \space hjeong@kaist.edu
\end{description}
\end{multicols}
